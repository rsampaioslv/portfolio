<?php
     ...
     $consulta = $pdo->query("SELECT * FROM certificados ORDER BY cert_situ DESC;");
?>
<!DOCTYPE html>
<html lang = "pt-br">
     <head>
         ...
         <!-- Font Awesome -->
         <link href = "stylesheet" href = "http://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css">
         <!-- Preloader -->
                         ...
                         <table class = "table table-striped" cellspacing = "0" cellpading = "0">
                            <thead>
                             ...
                             <tbody>
                                 ...
                                 ?>
                                 <tr>
                                     <td><?= $linha['cert_nome'] ?></td>
                                     <td><?= $linha['cert_inst'] ?></td>
                                     <td><?= $linha['cert_durc'] ?></td>
                                     <td><?= $linha['cert_situ'] ?></td>
                                 </tr>
                                 <?php
                                     }
                                 ?>
