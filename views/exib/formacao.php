<?php
     ...
     $consulta = $pdo->query("SELECT * FROM formacao ORDER BY form_term DESC;");
?>
<!DOCTYPE html>
<html lang = "pt-br">
     <head>
                 ...
                 <div class = "row pad_top">
                     <div class = "table-responsive col-md-12">
                         <table class = "table table-striped" cellspacing = "0" cellpading = "0">
                             <thead>
                                 <tr>
                                     <td><h3>Nome do curso:</h3></td>
                                     <td><h3>Nome da Instituição:</h3></td>
                                     <td><h3>Período:</h3></td>
                                     <td><h3>Início do curso:</h3></td>
                                     <td><h3>Final do curso:</h3></td>
                                 </tr>
                             </thead>
                             <tbody>
                             <?php
                             ...
                             ?>
                                 <tr>
                                     <td><?= $linha['form_nome'] ?></td>
                                     <td><?= $linha['form_inst'] ?></td>
                                     <td><?= $linha['form_peri'] ?></td>
                                     <td><?= $linha['form_com'] ?></td>
                                     <td><?= $linha['form_term'] ?></td>
                                 </tr>
                             </tbody>
                             <?php
                                 }
